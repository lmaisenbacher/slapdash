...
# from rpc.error import RPCResponseError
...
# def test_enum():
#     '''Test enum and enum props with custom client and server'''
...
# def test_enum_names():
#     '''setting the prop via a custom client and server with the enum name will raise a KeyError'''
...
#     '''you can get/set the prop with the str version of its value, using a custom client and server'''
...
# def test_mixed_enum():
#     '''test improbable enum with mixed-type values, using a custom client and server'''
